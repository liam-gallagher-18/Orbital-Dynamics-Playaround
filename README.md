...
While figure 1 shows that the difference between the two models is minimal within one of Neptune's orbital periods, figure 2 plots the difference between the two models over time.
